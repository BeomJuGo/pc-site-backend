...
형식: {칩제조사}({VRAM용량}GB {VRAM규격})/부스트 클럭: {MHz}MHz/TDP: {W}W/인터페이스: PCIe {버전}/출력: {포트 목록(예: HDMI 2.1×1, DP 2.1×3)}

예시: NVIDIA(24GB GDDR6X)/부스트 클럭: 2520MHz/TDP: 450W/인터페이스: PCIe 4.0/출력: HDMI 2.1×1, DP 1.4a×3
예시: AMD(16GB GDDR6)/부스트 클럭: 2615MHz/TDP: 260W/인터페이스: PCIe 4.0/출력: HDMI 2.1×1, DP 2.1×3
