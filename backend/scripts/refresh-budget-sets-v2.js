...
for (const budget of BUDGETS) {
  try {
    ...
    prevFloor = {
      minAmdCpuScore:         meta.amdCpuScore         || 0,
      prevAmdCpuComboPrice:   meta.amdCpuComboPrice    || 0,
      minIntelCpuScore:       meta.intelCpuScore       || 0,
      prevIntelCpuComboPrice: meta.intelCpuComboPrice  || 0,
