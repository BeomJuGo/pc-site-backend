      ...
      <div className="space-y-8">
        ...
        <Card className="bg-white/90 backdrop-blur-sm border-slate-200/50">
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-slate-500 text-sm mt-1">GitHub 리포지토리 이슈를 통한 문의도 가능합니다.</p>
          </CardContent>
        </Card>
        ...
        <div className="flex flex-wrap gap-4 justify-center pt-4">
          ...
          <Link to="/privacy" className="inline-flex items-center px-5 py-2.5 rounded-lg bg-white/20 text-white hover:bg-white/30 font-medium transition-colors">
            개인정보처리방침
          </Link>
          <Link to="/terms" className="inline-flex items-center px-5 py-2.5 rounded-lg bg-white/20 text-white hover:bg-white/30 font-medium transition-colors">
            이용약관
          </Link>
        </div>
      </div>
