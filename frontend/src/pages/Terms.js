    ...
    <div className="px-4 sm:px-6 lg:px-8 py-12 max-w-3xl mx-auto">
      <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
        ...
        <section className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">제4조 (저작권 및 데이터)</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">제5조 (면책)</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">제6조 (약관 변경)</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">제7조 (문의)</h2>
            <p>
