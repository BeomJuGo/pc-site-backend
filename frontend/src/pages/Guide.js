...
가성비PC에서는 AI 견적 추천 기능으로 예산과 용도(게임용·작업용·사무용·가성비)를 입력하면 호환되는 부품 조합을 추천받을 수 있습니다. 카테고리별로 가성비순·가격순 정렬을 활용해 본인 예산에 맞는 제품을 비교해 보시기 바랍니다.`,
  },
  {
    id: "cpu-selection",
...
PassMark·Cinebench 같은 벤치마크 점수는 성능을 한눈에 비교하는 데 도움이 됩니다. 단순히 점수만 높은 제품보다는, 예산 대비 성능 비율(가성비)이 좋은 제품을 고르는 것이 중요합니다. 가성비PC의 CPU 카테고리에서는 가성비순 정렬로 성능 대비 가격이 좋은 순서대로 목록을 확인할 수 있습니다.
...
가성비PC의 GPU 카테고리에서는 3DMark 점수순·가성비순 정렬로 성능과 가격을 함께 비교할 수 있습니다. NVIDIA와 AMD 제품을 필터로 나눠 보시면 브랜드별로 가성비 좋은 모델을 빠르게 찾을 수 있습니다.`,
  },
];
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-12 max-w-3xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-gray-600">
          예산·용도에 맞는 부품 선택을 위한 가이드 글입니다. 가성비PC 데이터와 함께 활용해 보세요.
        </p>
      </div>
